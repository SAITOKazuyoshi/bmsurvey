...
define('_MB_ORDER_ASC', '昇順');
define('_MB_ORDER_DESC', '降順');
...
define("_MB_New_Field","新しい質問を追加する");
...
define("_MB_View_Form_Results","アンケート結果");
...
define("_MB_Form_not_published","公開期間外のアンケートを開く事が出来ません");
define("_MB_Form_expired","受付を終了しました");
define("_MB_Form_is_not_active","このアンケートは公開されていません");
